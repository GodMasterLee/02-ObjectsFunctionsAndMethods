...
def try_methods_and_functions():
    ...
    william.pen = rg.Pen('blue',5)
    william.backward(150)
    william.speed = 1
    draw_many_squares(william,2,100,30)
    william.speed = 5
    william.pen = rg.Pen('red',5)
    draw_many_squares(william,10,50,15)
    william.speed = 100
    william.pen = rg.Pen('red',35)
    draw_many_squares(william,8,300,60)
    william.pen = rg.Pen('black',3)
    william.backward(200)
    william.draw_circle(30)
    william.draw_square(50)
    ###########################################################################
